...
export const Claim = (
  ...
  const populateClaimC = (onClick) => (
    <React.Fragment>
        ...
        <h1>Pixel Invader Drone Mint Tickets</h1>
        <p>Here you can claim your PIDT token which will allow you to mint your own Pixel Invader Drone for FREE later in February.</p>
      {claimMethod !== "" && claimData(claimMethod)}
        <div className="claim-box">
            <div className="lab">Amount: </div>
            <div className="val">{parseInt(amountStr) / 1_000_000_000}</div>
        ...
        onClick={(e) => {
          ...
          const wrap = async () => {
            try {
              ...
              notify({
                message: "Claim failed, please contact our team on Discord!",
                description: `Perhaps you have already claimed your reward, check your wallet balance.`,
              });
              setLoading(false);
            }
          };
